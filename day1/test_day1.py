...
def test_file_reader():
    assert len(read_lines_from_file("txts/day1_part1_example.txt")) == 4


def test_day1_example():
    expected_sum = 142

    example_list = read_lines_from_file('txts/day1_part1_example.txt')
...
def test_day1_part2_example():
    ...
    example_list = read_lines_from_file('txts/day1_part2_example.txt')
